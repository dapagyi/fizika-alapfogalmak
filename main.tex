...
\begin{itemize}
    ...
    \item Megmutatja az egységnyi idő alatt bekötvetkező elmozdulást.
...
\begin{itemize}
    ...
    \item Megmutatja az egységnyi tömegű halmaz hőmérsékletének egységnyivel való változtatása mekkore hőközlést igényel.
\end{itemize}
\end{af}
\begin{af}[Mólhő]
\begin{itemize}
    ...
    \item Megmutatja az egységnyi anyagmennyiségű halmaz hőmérsékletének egységnyivel való változtatása mekkore hőközlést igényel.
\end{itemize}
\end{af}
